            ...
            <div class="bg-white px-4 pt-5 pb-4 sm:p-6 sm:pb-4">
              <div class="sm:flex sm:items-start w-full">
                ...
                <div class="mt-3 text-center sm:mt-0 sm:ml-4 sm:text-left w-full">
                  <DialogTitle as="h3" class="text-lg leading-6 font-medium text-gray-900">Добавьте новую песню
                  </DialogTitle>
                  <div class="mt-2">
                    <div class="rounded-md shadow-sm -space-y-px">
                      ...
                      <div class="py-2">
                        ...
                        <div class="w-full flex items-center">
                          ...
                          <div class="flex w-1/2 justify-center"></div>
                        </div>
                      </div>
                      <div class="py-2">
                        <label for="genre_id">Жанр песни:</label>
                        <div class="w-full flex items-center">
                          <input id="genre_id" name="genre_id" type="number" max="7" min="1" autocomplete="genre_id"
                      ...
                      <div class="py-2">
                        ...
                        <div
                          class="relative border-dotted mt-2 h-16 cursor-pointer rounded-lg border-dashed border-2 border-indigo-700 bg-gray-100 flex justify-center items-center">
                          <div class="absolute">
                      ...
                      <div class="py-2">
                        ...
                        <div
                          class="relative mt-2 h-16 cursor-pointer rounded-lg  border-2 border-gray-700 bg-gray-100 flex justify-center items-center">
                          <div class="absolute">
                            <div class="flex flex-col items-center"><i
                              class="fa fa-folder-open fa-4x text-blue-700"></i>
                              <span class="block text-gray-400 font-normal">
