<template>
  <div class="relative mt-16 bg-deep-purple-accent-400 bg-gray-800">
    ...
    <div class="px-4 pt-12 mx-auto sm:max-w-xl md:max-w-full lg:max-w-screen-xl md:px-24 lg:px-8">
      <div class="w-full flex justify-center mb-8">
        <router-link :to="{name: 'Home'}" aria-label="Go home" title="Company" class="inline-flex items-center">
          ...
          <span class="ml-2 text-xl font-bold tracking-wide text-gray-100 uppercase">YourPiano</span>
        </router-link>
      </div>
      <div class="sm:flex-row pb-10">
        <p class="flex justify-center mb-3 text-sm text-gray-300">
          &copy; {{ new Date().getFullYear() }} Алексей Волчков. Все права защищены
        </p>
        <div class="flex justify-center items-center mt-4 space-x-4 sm:mt-0">
