<template>
  ...
  >
    <span v-if="userPoints" class="text-2xl text-white">{{userPoints}}/{{songPoints}} <span class="text-sm font-medium">набрано очков</span></span>
    <span v-else class="text-2xl text-white">Вы еще не играли эту песню</span>
  </p>
</template>
