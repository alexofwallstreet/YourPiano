      ...
      <div class="flex justify-between items-center border-b-2 border-gray-100 py-6 md:justify-start md:space-x-10">
        ...
        <PopoverGroup as="nav" class="hidden md:flex space-x-10">
          ...
          <router-link
            ...
            :key="item.name"
            :to="item.to"
            active-class="text-base font-medium text-gray-500 hover:text-gray-900"
            :class="[
          ...
          <div class="py-6 px-5 space-y-6">
            <div class="grid grid-cols-2 gap-y-4 gap-x-8">
              <router-link
                ...
                :key="item.name"
                :to="item.to"
                active-class="text-base font-medium text-gray-900 hover:text-gray-700"
                :class="[
                    this.$route.name === item.to.name
                    ? ''
            ...
            <div>
              ...
              <p class="mt-6 text-center text-base font-medium text-gray-500">
                Existing customer?
                {{ ' ' }}
                <router-link :to="Dashboard" class="text-indigo-600 hover:text-indigo-500"> Войти</router-link>
              </p>
            </div>
          </div>
        </div>
